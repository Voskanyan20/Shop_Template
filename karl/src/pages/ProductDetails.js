...
// import ProductDetailsPictures from "../components/ProductDetailsPictures";
...
class ProductDetails extends Component {
    ...
    interval = setInterval(() => {
        ...
        if (imageSlide === 3) {
            ...
            this.setState({imageSlide: imageSlide + 1})
        }
    }, 3000)
    ...
    handleClick = (e, i) => {
        ...
        let img = (e.target.alt) * 1;
        this.setState({imageSlide: img,active: i})
    }
                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <a href="#" className="backToHome d-block"><i
                                    className="fa fa-angle-double-left"/> Back to Category</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="single_product_thumb">
                                    <div id="product_details_slider" className="carousel slide" data-ride="carousel">
                                        <ol className="carousel-indicators">
                                            {images.map((image, i) => (
                                                <li className={active === i ? "active" : null}>
                                                    <a href={image} onClick={(e) => this.handleClick(e, i)}>
                                                        <img src={image} className="d-block w-100" alt={""}/></a>
                                                </li>
                                            ))}
                                        </ol>
                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <img className="d-block w-100" src={images[active]}
                                                     alt="First slide"/>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div id="collapseOne" className="collapse show" role="tabpanel"
                                                ...
                                                <div className="card-body">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
                                                        ...
                                                        Integ er bibendum sodales arcu id te mpus. Ut consectetur
                                                        lacus.</p>
                                            ...
                                            <div id="collapseTwo" className="collapse" role="tabpanel"
                                                ...
                                                <div className="card-body">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                        Explicabo quis in veritatis officia inventore, tempore provident
                                                        dignissimos nemo, nulla quaerat. Quibusdam non, eos, voluptatem
                                                        reprehenderit hic nam! Laboriosam, sapiente! Praesentium.</p>
                                            ...
                                            <div id="collapseThree" className="collapse" role="tabpanel"
                                                ...
                                                <div className="card-body">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse
                                                        quo sint repudiandae suscipit ab soluta delectus voluptate, vero
                                                        vitae, tempore maxime rerum iste dolorem mollitia perferendis
                                                        distinctio. Quibusdam laboriosam rerum distinctio. Repudiandae
                                                        fugit odit, sequi id!</p>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae
                                                        qui maxime consequatur laudantium temporibus ad et. A optio
                                                        inventore deleniti ipsa.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="col-12 col-lg-7">
                                                ...
                                                <form className="cart" method="post">
                                                    <div className="quantity">
                                                        ...
                                                        <input type="number" className="qty-text" id="qty2" step="1"
